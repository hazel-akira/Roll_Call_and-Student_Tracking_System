...
class RepairMigrationStateCommand extends Command
{
    ...
    private function migrationChecks(): array
    {
        return [
            ...
            '2026_05_25_081609_create_attendance_records_table' => fn (): bool => Schema::hasTable('attendance_records'),
            '2026_05_25_081609_create_attendance_sessions_table' => fn (): bool => Schema::hasTable('attendance_sessions'),
            '2026_05_25_081609_create_audit_logs_table' => fn (): bool => Schema::hasTable('audit_logs'),
            '2026_05_25_081609_create_dynamics_syncs_table' => fn (): bool => Schema::hasTable('dynamics_syncs'),
            '2026_05_25_081609_create_notifications_table' => fn (): bool => Schema::hasTable('notifications'),
            '2026_05_25_081609_create_refresh_tokens_table' => fn (): bool => Schema::hasTable('refresh_tokens'),
            '2026_05_25_081609_create_students_table' => fn (): bool => Schema::hasTable('students'),
            '2026_05_25_081609_create_subjects_table' => fn (): bool => Schema::hasTable('subjects'),
            '2026_05_25_081609_create_teacher_subjects_table' => fn (): bool => Schema::hasTable('teacher_subjects'),
